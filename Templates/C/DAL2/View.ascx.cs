...
using $rootnamespace$.$safeprojectfolder$.Components;
...
namespace $rootnamespace$.$safeprojectfolder$
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from $safeprojectfolder$ModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : $safeprojectfolder$ModuleBase, IActionable
    {
